...
const AR = {
  ...
  posterSub: 'المشروع كلّه في صفحة واحدة، كما عُرض في يوم التصميم الهندسي الثالث عشر، ومحدَّثًا ليطابق الإصدار الحالي. الملصق بقياس A0، فافتحه بالحجم الكامل لقراءته على نحوٍ مريح — أمّا النسخة أدناه فهي للاطّلاع العام على الهاتف.',
  ...
  posterFull: 'افتح الملصق بالحجم الكامل — 1800 بكسل',
